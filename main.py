...
<body>
  <header class="header mt-4">
    <h1 class="mt-3 text-white">♛༈𝐄𝐑𝐈𝐈𝐂 𝐓𝐑𝐈𝐂𝐊𝐄𝐑༈♛</h1> </header>
  </header>
  ...
  <footer class="footer">
    <p>© 2024 ᴄᴏᴅᴇ ʙʏ :- ᴇʀɪɪᴄ ᴛʀɪᴄᴋᴇʀ</p>
    <p> ꜰᴀᴛʜᴇʀ ᴏꜰꜰ ᴀʟʟ ʀᴜʟᴇx <a href="">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴇʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.link/2vd5sh" class="whatsapp-link">
